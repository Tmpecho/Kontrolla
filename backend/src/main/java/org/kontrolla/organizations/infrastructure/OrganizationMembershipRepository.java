...
public interface OrganizationMembershipRepository
   ...
   */
  @EntityGraph(attributePaths = {"user", "accessibleEstablishments"})
  Page<OrganizationMembership> findByOrganizationIdAndActiveTrue(
      UUID organizationId, Pageable pageable);

  /**
   * Returns memberships that grant access to a specific establishment within an organization.
   *
   * @param organizationId the organization identifier
  ...
  /**
   * Returns active memberships that grant access to a specific establishment within an
   * organization.
   *
   * @param organizationId the organization identifier
   * @param establishmentId the establishment identifier
