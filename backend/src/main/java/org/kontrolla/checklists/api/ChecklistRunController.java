...
@RestController
@RequestMapping(
    "/api/v1/organizations/{organizationId}/establishments/{establishmentId}/checklists/runs")
public class ChecklistRunController {
  ...
  public ChecklistRunResponse getChecklistRun(
    ...
    return ChecklistRunResponse.from(
        checklistRunService.getChecklistRun(
            organizationId, establishmentId, checklistRunId, currentUser));
  }
  ...
  public void removeChecklistRunAssignment(
    ...
    checklistRunService.removeChecklistRunAssignment(
        organizationId, establishmentId, checklistRunId, assignmentId, currentUser);
  }
  ...
  private UpdateChecklistTaskCommand toUpdateChecklistTaskCommand(
