...
/**
 * Immutable description of an audit event before request and security context
...
public final class AuditRecord {
	...
	/**
	 * Returns event metadata that should be persisted and logged with the audit
	 * entry.
	 *
	...
	/**
	 * Builder for composing audit records with optional actor, target, and
	 * metadata fields.
	 */
