...
/**
 * Default audit recorder that persists audit events and emits a structured log entry after
 * transaction commit.
 */
@Service
public class TransactionalAuditRecorder implements AuditRecorder {
   ...
   * @param auditRequestContextResolver resolver that enriches records with request context
