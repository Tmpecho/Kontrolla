...
public interface EstablishmentRepository extends JpaRepository<Establishment, UUID> {
  ...
  /**
   * Returns establishments within an organization that are accessible to a specific user through
   * membership rules.
   *
   * @param organizationId the organization identifier
  ...
  /**
   * Returns the earliest-created establishment with a specific status in an organization.
   *
   * @param organizationId the organization identifier
  ...
  Optional<Establishment> findFirstByOrganizationIdAndStatusOrderByCreatedAtAsc(
      UUID organizationId, EstablishmentStatus status);
   ...
   */
  @EntityGraph(attributePaths = {"organization"})
  Optional<Establishment> findFirstByOrganizationIdAndNameIgnoreCase(
