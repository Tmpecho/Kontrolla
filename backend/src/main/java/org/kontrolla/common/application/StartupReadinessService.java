...
/**
 * Tracks whether application startup has completed so readiness checks can distinguish between a
 * booting and fully ready backend instance.
 */
@Service
public class StartupReadinessService {
  ...
  /**
   * Indicates whether the application has finished startup and is ready to serve requests.
   *
