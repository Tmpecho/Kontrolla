...
/**
 * Listens for the Spring application-ready event and marks the backend as ready once startup has
 * completed.
 */
@Component
public class StartupReadinessListener {
  ...
  /** Handles the application-ready event emitted by Spring after startup has completed. */
