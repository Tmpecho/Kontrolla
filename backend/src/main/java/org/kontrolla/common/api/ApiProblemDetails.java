...
/**
 * Utility for creating consistently structured RFC 7807 problem detail responses for API errors.
 */
public final class ApiProblemDetails {
  ...
  /**
   * Creates a problem detail payload with shared metadata used across API error responses.
   *
