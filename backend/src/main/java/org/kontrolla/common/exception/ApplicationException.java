...
/**
 * Base runtime exception for application errors that should be translated into
...
public class ApplicationException extends RuntimeException {
	...
	/**
	 * Creates an application exception with the HTTP status and error code that
	 * should be exposed by the API layer.
	 *
